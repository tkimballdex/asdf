...
export class ShipmentListComponent extends PageComponent implements OnInit {

	constructor(private repository: ShipmentRepository, private tenant: TenantService, private appService: AppService, private formState: FormState) {
        super();
    }
    //------------------------------------------------------------------------------------------------------------------------
    public list: any;
   ...
   @ViewChild('grid') public grid: GridComponent;
	...
	async search() {
		...
		this.showSpinner();
		this.list = await this.repository.listSamples({
