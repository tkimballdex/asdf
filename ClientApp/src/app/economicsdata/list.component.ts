...
import { economicsdataRepositary } from './repository';
...
@Component({
    selector: 'economicsdata-list',
    templateUrl: './list.component.html',
})
export class economicsdataListComponent extends PageComponent implements OnInit {
	constructor(private repository: economicsdataRepositary, private appService: AppService, private tenant: TenantService, private formState: FormState) {
        super();
    }
